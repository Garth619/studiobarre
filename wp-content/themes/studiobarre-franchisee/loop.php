...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<a id="mythumb" href="<?php the_permalink(); ?>"><?php the_post_thumbnail(); ?></a>
			<h2 class="entry-title" style="padding-top:10px;"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
