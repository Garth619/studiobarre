...
<div id="wrapper" class="hfeed">
	...
	<div class="find">
		<!-- <a href="http://processpeak.com/staging/studio-barre/find-a-studio/">find your studio</a> -->
	</div>
	<a class="tagline" href="<?php bloginfo( 'url' ); ?>"><img src="<?php bloginfo( 'template_directory' ); ?>/images/franchise-logo.png"/></a>
