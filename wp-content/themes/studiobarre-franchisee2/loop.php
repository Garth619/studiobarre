...
<?php if ( ! have_posts() ) : ?>
	<div id="post-0" class="post error404 not-found">
		<h1 class="entry-title">Events Coming Soon</h1>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<a class="event_title" href="<?php the_permalink(); ?> "><?php the_title(); ?></a>
			<a class="event_date" style="color:#fff;" href="<?php the_permalink(); ?> "><?php the_field('date'); ?></a>
